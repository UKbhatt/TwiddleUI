...
export default function Playground() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-row animate-fadeIn bg-gradient-to-br from-[#181928] via-[#232f42] to-[#13111c]">
      <ComponentList value={componentType} onChange={setComponentType} />
      <div className="flex-1 flex flex-col items-center justify-start pt-8 px-2 sm:px-4">
        ...
        <div className="w-full max-w-5xl bg-white/10 backdrop-blur-2xl shadow-2xl rounded-3xl p-4 sm:p-8 flex flex-col md:flex-row gap-7 mb-10 border border-white/10 transition duration-300">
          ...
          <div className="hidden md:flex flex-col justify-center">
            <div className="h-60 w-px bg-gradient-to-b from-white/10 
            via-slate-700/60 to-white/10"></div>
          </div>
